/* Keloer Finanz - i18n.js v4 - Toutes les cles */
'use strict';
var I18N = {
  defaultLang: 'de',
  ...
  de: {
    topbar: { text:'Keloer Finanz - ACPR-zugelassen - Einlagen bis 100.000 EUR gesichert', branches:'Filialen', client_space:'Kundenbereich', contact:'Kontakt', tag:'Versicherungen & Kredit' },
    ...
    footer: { our_loans:'Unsere Kredite', business:'Unternehmen', info:'Informationen', about:'Ueber uns', legal:'Impressum', privacy:'Datenschutz', cgu:'AGB', contact:'Kontakt', copyright:'2025 Keloer Finanz. Alle Rechte vorbehalten.', license:'ACPR-Zulassung Nr. 8883053936', brand_desc:'Zugelassene Privatgesellschaft. Aktiengesellschaft mit einem Kapital von 10.000.000 EUR.' },
    ...
    dash: {
      client_type:'Privatkunde',
      client_since:'Kunde seit', overview:'Uebersicht', my_file:'Meine Akte', messaging:'Nachrichten', documents:'Dokumente', alerts:'Benachrichtigungen', my_profile:'Mein Profil', security:'Kontosicherheit',

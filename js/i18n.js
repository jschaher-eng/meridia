...
var I18N = {
  ...
  de: {
    ...
    auth: { title:'Kundenbereich B-Mo Financial', login_tab:'Anmelden', register_tab:'Konto erstellen', email:'E-Mail-Adresse', password:'Passwort', remember:'Angemeldet bleiben', forgot:'Passwort vergessen?', login_btn:'Zu meinem Bereich', ssl_note:'SSL-verschluesselte Verbindung - 2FA verfuegbar', register_note:'Erstellen Sie Ihren Bereich, um einen Antrag zu stellen und Ihren Vorgang zu verfolgen.', profile_label:'Profil', individual:'Privatperson', business:'Unternehmen / KMU', accept_text:'Ich akzeptiere die AGB und die Datenschutzrichtlinie von B-Mo Financial.', create_btn:'Konto erstellen', auth.confirm_password: 'Passwort bestaetigen'},

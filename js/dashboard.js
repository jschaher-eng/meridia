    ...
    return '<div class="dbox" style="margin-bottom:1rem">' +
      ...
      (inv.status !== 'paid' ? 
        '<div style="background:var(--navy);border-radius:8px;padding:1.25rem;margin-top:1rem">' +
          ...
          '<div class="prow" style="border-color:rgba(255,255,255,0.1)"><span class="plbl" style="color:rgba(255,255,255,0.6)">Verwendungszweck</span><span class="pval" style="color:var(--gold-l);font-weight:500">' + (inv.reference || '—') + '</span></div>' +
       '</div>'
      : '') +
    '</div>';
  }).join('');
